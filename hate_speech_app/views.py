...
def preview(request):
    if request.method == 'POST':
        try:
            ...
            print("Uploaded file:", dataset.name)
            ...
            print(df.head())
            return render(request, "preview.html", {'df_view': df})
        except KeyError:
            print("File 'datasetfile' not found in request.FILES")
            # Handle missing file error here
